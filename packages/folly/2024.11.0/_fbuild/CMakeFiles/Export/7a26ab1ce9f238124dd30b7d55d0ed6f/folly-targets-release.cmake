...
set_target_properties(Folly::folly PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfolly.0.58.0-dev.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfolly.0.58.0-dev.dylib"
  )

list(APPEND _cmake_import_check_targets Folly::folly )
list(APPEND _cmake_import_check_files_for_Folly::folly "${_IMPORT_PREFIX}/lib/libfolly.0.58.0-dev.dylib" )
...
set_target_properties(Folly::folly_test_util PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfolly_test_util.0.58.0-dev.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfolly_test_util.0.58.0-dev.dylib"
  )

list(APPEND _cmake_import_check_targets Folly::folly_test_util )
list(APPEND _cmake_import_check_files_for_Folly::folly_test_util "${_IMPORT_PREFIX}/lib/libfolly_test_util.0.58.0-dev.dylib" )
...
set_target_properties(Folly::follybenchmark PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfollybenchmark.0.58.0-dev.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfollybenchmark.0.58.0-dev.dylib"
  )

list(APPEND _cmake_import_check_targets Folly::follybenchmark )
list(APPEND _cmake_import_check_files_for_Folly::follybenchmark "${_IMPORT_PREFIX}/lib/libfollybenchmark.0.58.0-dev.dylib" )
